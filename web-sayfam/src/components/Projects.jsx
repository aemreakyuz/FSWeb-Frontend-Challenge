...
function Projects() {
  ...
  <div className="w-[80%]  mx-auto mb-[7rem]">
    <h3 className="text-[48px] mb-8 dark:text-[#AEBCCF] m:text-center" >{texts.projectsTitle}</h3>
    ...
    {texts.projects.map((project)=>(
      ...
      <div className=""> 
        <a href={project.url} className="text-[30px] dark:text-[#CFCBFF] py-4 inline-flex">{project.title} </a>
